...
$timeslots = $_POST['timeslots']? implode(',', $_POST['timeslots']) : '';
$sql=mysqli_query($con,"Update doctors set specilization='$docspecialization',doctorName='$docname',address='$docaddress',docFees='$docfees',contactno='$doccontactno',docEmail='$docemail', timeslots ='$timeslots' where id='$did'");
if($sql)
{
...
while($data=mysqli_fetch_array($sql))
{
		...
		$timeslots = explode(',', $data['timeslots']);	
?>
...
<div class="form-group">
					...
					<input type="email" name="docemail" class="form-control"  readonly="readonly"  value="<?php echo htmlentities($data['docEmail']);?>">
														...
														<div class="form-group">
        <label for="timeslots">Available Timeslots</label><br>
        ...
        ?> 
            <div class="checkbox">
                <label>
                    <input type="checkbox" name="timeslots[]" value="<?php echo $slot; ?>" <?php echo $checked; ?>>
                    <?php echo $slot; ?>
                </label>
            </div>
        <?php } ?>
